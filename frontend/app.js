      ...
      status === 'success'
        ...
        : e('div', null,
            e('h2', { className: 'sheet__title' },
              'Хочу стать ', e('em', { style: { fontStyle: 'italic', color: 'var(--accent)' } }, 'спикером.')),
            e('p', { style: { color: 'var(--ink-3)', margin: '0 0 18px', fontSize: 14 } },
              'Коротко — кто вы, о чём хотите рассказать, и где с вами связаться.'),
            ...
            e('div', { className: 'field' },
              e('label', { className: 'field-lbl' }, 'О себе и теме'),
              e('textarea', {
                className: 'textarea',
                placeholder: 'Тема, опыт, ссылки на прошлые выступления…',
                value: message,
